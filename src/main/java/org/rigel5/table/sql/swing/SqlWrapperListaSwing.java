...
public class SqlWrapperListaSwing extends SwingSqlWrapperBase
{
  ...
  {
    ptm = new org.rigel5.table.sql.swing.SqlTableModel();
  }

  public org.rigel5.table.sql.swing.SqlTableModel getTM()
  {
    return ((org.rigel5.table.sql.swing.SqlTableModel) (ptm));
  }
