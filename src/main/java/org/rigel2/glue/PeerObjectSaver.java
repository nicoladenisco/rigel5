...
/**
 * Salvataggio degli oggetti Peer.
 *
 * @author Nicola De Nisco
 */
public interface PeerObjectSaver
{
  /**
   * Inizilizza con un oggetto Peer di Torque.
   * @param objectClass
   * @param peerClass
   * @throws Exception
   */
  public void init(Class objectClass, Class peerClass)
     throws Exception;
