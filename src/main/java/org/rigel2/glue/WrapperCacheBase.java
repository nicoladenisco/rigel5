...
import org.rigel2.glue.pager.PeerPagerAppMaint;
import org.rigel2.glue.pager.PeerTablePagerEditApp;
import org.rigel2.glue.pager.SqlPagerAppMaint;
...
import org.rigel2.table.html.wrapper.MasterDetailInfo;
...
abstract public class WrapperCacheBase
{
     ...
     throws Exception
  {
    ...
    org.rigel2.table.peer.html.PeerTableModel ptm = (org.rigel2.table.peer.html.PeerTableModel) wl.getPtm();
