...
import org.rigel2.db.*;

/**
 * <p>Title: Gestore connessioni SQL per applicazioni Turbine.</p>
 * <p>Description: Produce un oggetto <b>java.sql.Connection</b> da utilizzare
 * delle classi Sql... del fremework.</p>
 * <p>Questa implementazione e' specializzata per lavorare
...
public class TurbineConnectionProducer implements ConnectionProducer
{
  ...
  @Override
  public ConnectionHolder getConnectionHolder() throws Exception
  {
