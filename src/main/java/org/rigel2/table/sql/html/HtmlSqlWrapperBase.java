...
import java.util.*;
import org.rigel2.SqlUtils;
import org.rigel2.db.sql.*;
import org.rigel2.db.torque.CriteriaRigel;
import org.rigel2.exceptions.*;
import org.rigel2.table.*;
import org.rigel2.table.html.wrapper.*;
import org.rigel2.table.sql.SqlSelectParam;

/**
 * <p>Title: Classe base di tutti i Wrapper basati su query SQL libere.</p>
 * <p>Description: Questa e' la classe base dei Wrapper
...
abstract public class HtmlSqlWrapperBase extends HtmlWrapperBase
{
     ...
     throws Exception
  {
    ...
    while(enumParam.hasMoreElements())
    {
      ...
      sOut +=
         "<input type=\"hidden\" name=\"" + nomec + "\" value=\"" + valore + "\">\r\n";
    }
